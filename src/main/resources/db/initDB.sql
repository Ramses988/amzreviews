...
DROP TABLE IF EXISTS articles_us;
...
CREATE UNIQUE INDEX article_ru_unique_name_idx ON articles_ru (name);

CREATE TABLE articles_us
(
    id              INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    date            TIMESTAMP                NOT NULL,
    name            VARCHAR                  NOT NULL,
...
CREATE UNIQUE INDEX article_us_unique_name_idx ON articles_us (name);
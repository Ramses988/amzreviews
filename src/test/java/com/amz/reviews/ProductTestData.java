...
public class ProductTestData {
    ...
    public static final Product PRODUCT_1 = new Product(1, of(2019, Month.MAY, 30, 10, 0), "Product_1", "B079JD7F7G",
            "TP-Link AC1750 Smart WiFi Router", 57.99,
            "WiFi Router,Wavlink Remote AC1200 Smart WiFi Router with Touchlink Function,High Speed 2.4G+5GHz Dual Band Gigabit Wireless Internet Router for Online Game&Home",
            "https://images-na.ssl-images-amazon.com/images/I/51PlzLkwAIL.jpg",0, 0);
    public static final Product PRODUCT_2 = new Product(2, of(2019, Month.MAY, 30, 13, 0), "Product_2", "B07PZL2BMH",
            "SUNGAIT Ultra Lightweight", 12.75, "SUNGAIT Ultra Lightweight Rectangular Polarized", "img", 0, 0);
    public static final Product PRODUCT_3 = new Product(3, of(2019, Month.MAY, 30, 15, 0), "Product_3", "B07L2NJKMK",
            "Wireless Earbuds", 29.99, "Wireless Earbuds, Letsfit Bluetooth 5.0","img",  0, 0);
    public static final Product PRODUCT_4 = new Product(4, of(2019, Month.MAY, 30, 17, 0), "Product_4", "B07GPHG3L7",
            "Tea Tree Body Wash", 12.59, "Tea Tree Body Wash, Helps Nail Fungus, Athletes Foot","img",  0, 0);
    public static final Product PRODUCT_5 = new Product(5, of(2019, Month.MAY, 30, 19, 0), "Product_5", "B07JB8BMJT",
            "Etekcity EK5150", 15.29, "Etekcity EK5150 Digital Food Kitchen Scale for Cooking", "img", 0, 0);

    public static final Product NEW_PRODUCT = new Product(null, of(2019, Month.MAY, 31, 13, 0), "Product_New", "B07C3Y4Q8S",
            "AmazonBasics Fade-Resistant", 7, "AmazonBasics Fade-Resistant Cotton Hand Towel","img",  0, 0);

    public static final Product PRODUCT_MODIFED = new Product(1, of(2019, Month.MAY, 30, 10, 0), "Modifed", "B079JD7F7G",
            "TP-Link AC1750 Smart WiFi Router", 53, "TP-Link AC1750 Smart WiFi Router", "img", 0, 0);

    public static void assertMatch(Product actual, Product expected) {
        assertThat(actual).isEqualToIgnoringGivenFields(expected,"user", "orders", "images");
    }
    ...
    public static void assertMatch(Iterable<Product> actual, Iterable<Product> expected) {
        assertThat(actual).usingElementComparatorIgnoringFields("user", "orders", "images").isEqualTo(expected);
    }
}